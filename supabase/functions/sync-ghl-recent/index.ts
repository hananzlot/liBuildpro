    ...
    for (const integration of integrations as GHLIntegration[]) {
      ...
      for (const contactId of allContactsToFetch) {
        ...
        if (contact) {
          ...
          contactsToUpsert.push({
            ...
            source: contact.source || null,
            tags: contact.tags || [],
            assigned_to: contact.assignedTo ? (salespersonLookup.get(contact.assignedTo) || contact.assignedTo) : null,
      ...
      for (const o of opportunities) {
        ...
        oppsToUpsert.push({
          ...
          assigned_to: o.assignedTo ? (salespersonLookup.get(o.assignedTo) || o.assignedTo) : null,
      ...
      const apptsToUpsert = filteredAppointments.map(a => ({
        ...
        assigned_user_id: a.assignedUserId ? (salespersonLookup.get(a.assignedUserId) || a.assignedUserId) : null,
