        ...
        <Card className="border-0 shadow-xl overflow-hidden">
          ...
          <div className="bg-slate-50 rounded-lg p-4">
            <div className="flex items-center gap-2 text-slate-500 mb-1.5">
              ...
              <span className="text-[10px] uppercase tracking-wider font-medium">Contract Title</span>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex items-center gap-3 bg-green-50 border border-green-100 rounded-lg px-4 py-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-sm text-green-800">Digitally Signed & Verified</p>
