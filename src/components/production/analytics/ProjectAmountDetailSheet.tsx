      ...
      <SheetContent className="w-full sm:max-w-2xl overflow-y-auto">
        ...
        <div className="mt-6">
          ...
          {amountType === 'collected' && (
            <CollectedContent payments={receivedPayments} total={totalCollected} />
          )}

          {/* Bills Paid */}
          {amountType === 'billsPaid' && (
            <BillsPaidContent bills={bills} total={totalBillsPaid} />
          )}
...
// Collected Content
function CollectedContent({ payments, total }: { payments: any[]; total: number }) {
  return (
    <div className="space-y-4">
      <div className="flex justify-end">
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Schedule/Phase</TableHead>
          ...
          <TableBody>
            {payments.map((p) => (
              <TableRow key={p.id}>
                ...
                <TableCell>{p.payment_schedule || '-'}</TableCell>
...
// Bills Paid Content
function BillsPaidContent({ bills, total }: { bills: any[]; total: number }) {
