...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Outstanding A/R", url: "/outstanding-ar", icon: FileText, roles: ['super_admin', 'admin', 'production'], requiredFeature: 'production', dynamicSuffix: 'ar' },
      { title: "Outstanding A/P", url: "/outstanding-ap?tab=scheduled", icon: Briefcase, roles: ['super_admin', 'admin', 'production'], requiredFeature: 'production', dynamicSuffix: 'ap' },
    ],
  },
  {
    label: "Propose & Sign",
        ...
        {visibleSections.map((section) => {
          ...
          return (
            <Collapsible key={section.label} open={collapsed || sectionOpen} onOpenChange={() => toggleSection(section.label)}>
              <SidebarGroup className="px-2 py-0.5 mx-1 my-0.5 rounded-md bg-sidebar-surface-hover/40">
                <CollapsibleTrigger asChild>
